export const ru = {
    "auth": {
        ...
        "signInPage": {
            "title": "Войти • Inctagram",
            "h1": "Войти",
            "meta_description": "С возвращением в Inctagram! Войдите, чтобы увидеть снимки и записи, сделанные вашими друзьями, родственниками и интересными вам людьми по всему миру",
        ...
        "signUpPage": {
            ...
            "meta_description": "Присоединяйтесь к Inctagram! Зарегистрируйтесь, чтобы просматривать фото, видео, истории и сообщения от своих друзей, родственников, а также интересных людей со всего мира",
            "question": "У тебя есть аккаунт?",
            "privacyTerms": "Я согласен с <a href='/sign-up/terms-of-service'>условиями обслуживания</a> и <a href='/sign-up/privacy-policy'>политикой конфиденциальности</a>"
        },
        "mergerPage": {
        ...
        "forgotPasswordPage": {
            ...
            "h1": "Забыли пароль?",
            "meta_description": "Не можете войти? Введите свой адрес электронной почты и мы вышлем вам вам дальнейшие инструкции для возврата в вашу учетную запись",
        ...
        "modal": {
            ...
            "modalVerificationText": "Мы отправили ссылку для подтверждения вашего электронного письма по адресу EMAIL"
        },
        "createNewPassword": {
        ...
        "error": {
            ...
            "userIsAdult": "Пользователь младше 13 лет не может создать профиль. Политика конфиденциальности",
    ...
    "modal": {
        ...
        "followingModalUnfollowDescription": "Вы действительно хотите отписаться от этого пользователя “URLProfiele”?",
        "errorTransactionModalTitle": "Ошибка",
        "errorTransactionModalDescription": "Транзакция завершилась неудачей, пожалуйста, повторите попытку",
        ...
        "closeModalText": "Вы действительно хотите закрыть создание публикации? Если вы закроете, все будет удалено",
...
export type LocalType = typeof ru